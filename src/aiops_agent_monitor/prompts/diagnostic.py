...
AVAILABLE_DATA_PROMPT = (
    ...
    "  node_load1\n"
    "- SystemMetrics (component CPU, Memory or Disk) returns these host values in one call: prefer it.\n"
    ...
    "Plan by alert type:\n"
    "- CPU or load: SystemMetrics(CPU), then node_load1 if needed.\n"
    "- Memory: SystemMetrics(Memory), then LokiLogSearch for OOM or errors if needed.\n"
    ...
    "SystemMetrics and the host PromQL queries return the same values: use one, never both. "
